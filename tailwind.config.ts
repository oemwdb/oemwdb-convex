		...
		extend: {
			...
			keyframes: {
				...
				'wheel-chase': {
					...
					'49.9%': { transform: 'translateX(198px) rotateZ(720deg)' },
					'50%': { transform: 'translateX(198px) rotateZ(720deg)' },
					'99.9%': { transform: 'translateX(0) rotateZ(0deg)' },
			...
			animation: {
				...
				'ghost-float': 'ghost-float 4s ease-in-out infinite 0.333s',
				'wheel-chase': 'wheel-chase 4s ease-in-out infinite',
