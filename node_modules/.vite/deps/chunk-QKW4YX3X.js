...
function transformer3() {
  var x0 = 0, x1 = 0.5, x2 = 1, s2 = 1, t04, t14, t22, k10, k21, interpolator = identity3, transform, clamp = false, unknown;
  function scale(x3) {
    return isNaN(x3 = +x3) ? unknown : (x3 = 0.5 + ((x3 = +transform(x3)) - t14) * (s2 * x3 < s2 * t14 ? k10 : k21), interpolator(clamp ? Math.max(0, Math.min(1, x3)) : x3));
  }
  scale.domain = function(_) {
    return arguments.length ? ([x0, x1, x2] = _, t04 = transform(x0 = +x0), t14 = transform(x1 = +x1), t22 = transform(x2 = +x2), k10 = t04 === t14 ? 0 : 0.5 / (t14 - t04), k21 = t14 === t22 ? 0 : 0.5 / (t22 - t14), s2 = t14 < t04 ? -1 : 1, scale) : [x0, x1, x2];
  };
  scale.clamp = function(_) {
    return arguments.length ? (clamp = !!_, scale) : clamp;
  };
  ...
  return function(t) {
    transform = t, t04 = t(x0), t14 = t(x1), t22 = t(x2), k10 = t04 === t14 ? 0 : 0.5 / (t14 - t04), k21 = t14 === t22 ? 0 : 0.5 / (t22 - t14), s2 = t14 < t04 ? -1 : 1;
    return scale;
  };
}
function diverging() {
...
//# sourceMappingURL=chunk-QKW4YX3X.js.map
