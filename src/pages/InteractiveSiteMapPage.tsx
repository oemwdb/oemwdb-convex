...
const InteractiveSiteMapPage = () => {
  const mermaidDiagram = `
    graph TD
      ...
      %% Data Management
      DataTables --> RelationMaker["Relation Maker"]
      ...
      class Dev,DevDash,DataTables,Database,Templates,CardSystem,Collections,MasterItems,PageTemplates,RelationMaker devPage
