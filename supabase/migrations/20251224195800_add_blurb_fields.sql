...
-- private_blurb: internal notes for inter-agent context handoff
...
COMMENT ON COLUMN oem_brands.private_blurb IS 'Internal notes for inter-agent context handoff';

COMMENT ON COLUMN oem_vehicles.public_blurb IS 'Public-facing description/blurb for this vehicle';
COMMENT ON COLUMN oem_vehicles.private_blurb IS 'Internal notes for inter-agent context handoff';

COMMENT ON COLUMN oem_wheels.public_blurb IS 'Public-facing description/blurb for this wheel';
COMMENT ON COLUMN oem_wheels.private_blurb IS 'Internal notes for inter-agent context handoff';
